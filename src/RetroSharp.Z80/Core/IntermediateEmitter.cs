...
public class IntermediateEmitter
{
    ...
    public IEnumerable<string> Call(RetroSharp.Generation.Intermediate.Model.Codes.Call call)
    {
    ...
    public IEnumerable<string> CleanArgs(RetroSharp.Generation.Intermediate.Model.Codes.CleanArgs clean)
    {
