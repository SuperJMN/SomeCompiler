...
//    {
//        return new BoundBinaryExpression(Bind(binaryExpression.Left), Bind(binaryExpression.Right), binaryExpression.Operator is AddOperator ? BinaryOperator.Add : BinaryOperator.Subtract);
//    }
